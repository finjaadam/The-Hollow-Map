...
func _ready():
	$"HFlowContainer/Background_(left)".mouse_entered.connect(_on_color_rect_mouse_entered)
	$"HFlowContainer/Background_(left)".mouse_exited.connect(_on_color_rect_mouse_exited)
